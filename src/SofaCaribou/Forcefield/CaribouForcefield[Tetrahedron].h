...
template <> void CaribouForcefield<caribou::geometry::Tetrahedron < caribou::Linear>>::triangulate_face(const caribou::geometry::Tetrahedron < caribou::Linear> & e, const std::size_t & face_id, std::vector<sofa::defaulttype::Vector3> & triangles_nodes);
...
template <> void CaribouForcefield<caribou::geometry::Tetrahedron < caribou::Quadratic>>::triangulate_face(const caribou::geometry::Tetrahedron < caribou::Quadratic> & e, const std::size_t & face_id, std::vector<sofa::defaulttype::Vector3> & triangles_nodes);
